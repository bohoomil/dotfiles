...
static const char colors[NUMCOLORS][ColLast][25] = {
  ...
  { "#001833", "#005577", "#000000" }, // 25 19 dwm selbg
};
...
static const Rule rules[] = {
  ...
  { "Gnome-font-viewer", NULL,    NULL,              0,    True,    True, -1 },
  { "Mate-font-viewer",  NULL,    NULL,              0,    True,    True, -1 },
  ...
  { "Gpartedbin",        NULL,    NULL,              0,    True,    True, -1 },
...
static const char *lohis[] = { "lolictrl", "-l", NULL };
static const char *losyn[] = { "prim2clip", NULL };
