...
" with the euphrasia3 .Xdefaults colour settings.
...
if &t_Co > 255
  ...
  hi IncSearch               ctermfg=255   ctermbg=28
  ...
  hi Search                  ctermfg=255  ctermbg=28
  ...
  " statusline
  hi StatusLine              ctermfg=7    ctermbg=94    cterm=none
  hi StatusLineNC            ctermfg=94    ctermbg=7
  hi StatusModFlag           ctermfg=52   ctermbg=94 
  hi StatusRO                ctermfg=13   ctermbg=94    cterm=none
  hi StatusHLP               ctermfg=10   ctermbg=94    cterm=none
  hi StatusPRV               ctermfg=11   ctermbg=94    cterm=none
  hi StatusFTP               ctermfg=6    ctermbg=94    cterm=none
  ...
  hi IncSearch               ctermfg=white   ctermbg=green   term=bold
  ...
  hi Search                  ctermfg=white   ctermbg=green   term=bold
  ...
  " statusline
  hi StatusLine              ctermfg=red     ctermbg=white   term=none
  hi StatusLineNC            ctermfg=white   ctermbg=red     term=none
  hi StatusModFlag           ctermfg=red     ctermbg=white   term=none
  hi StatusRO                ctermfg=magenta ctermbg=white   term=none
  hi StatusHLP               ctermfg=green   ctermbg=white   term=none
  hi StatusPRV               ctermfg=yellow  ctermbg=white   term=none
  hi StatusFTP               ctermfg=cyan    ctermbg=white   term=none
  ...
  hi PmenuSel                ctermfg=none    ctermbg=black   term=bold
  hi PmenuSbar               ctermfg=black   ctermbg=white   term=bold

  " html
  hi htmlTag                 ctermfg=blue                    term=bold
  hi htmlEndTag              ctermfg=blue                    term=bold
  hi htmlTagName             ctermfg=yellow

  " xml
  hi xmlTag                  ctermfg=cyan
  hi xmlEndTag               ctermfg=cyan
  hi xmlTagName              ctermfg=yellow                  term=bold

  " perl
  hi perlStatement           ctermfg=magenta                 term=bold
  hi perlStatementStorage    ctermfg=red
  hi perlVarPlain            ctermfg=cyan
  hi perlVarPlain2           ctermfg=yellow                  term=bold

  " mini buffer explorer
  hi MBENormal               ctermfg=black                   term=bold
  hi MBEChanged              ctermfg=red
  hi MBEVisibleNormal        ctermfg=magenta
  hi MBEVisibleNormalActive  ctermfg=magenta                 term=bold
  hi MBEVisibleChanged       ctermfg=white
  hi MBEVisibleChangedActive ctermfg=red                     term=bold

  " rst
  hi rstEmphasis             ctermfg=white                   term=underline
  hi rstLiteralBlock         ctermfg=yellow
  hi rstInlineLiteral        ctermfg=yellow                  term=bold
  hi rstSections             ctermfg=red
  hi rstHyperlinkTarget      ctermfg=cyan
  hi rstStandaloneHyperlink  ctermfg=green                   term=bold
  hi rstInterpretedTextOrHyperlinkReference ctermfg=green    term=bold
  hi rstCitation             ctermfg=black                   term=bold
  hi rstQuotedLiteralBlock   ctermfg=yellow                  term=bold
...
"
  ...
  " statusline
  hi StatusLine              guifg=#aeaeae   guibg=#a63131   gui=none
  hi StatusLineNC            guifg=#a63131   guibg=#aeaeae
  hi StatusModFlag           guifg=#cc475d   guibg=#a63131   gui=none
  hi StatusRO                guifg=#bf567d   guibg=#a63131   gui=none
  hi StatusHLP               guifg=#5eb33e   guibg=#a63131   gui=none
  hi StatusPRV               guifg=#e6c473   guibg=#a63131   gui=none
  hi StatusFTP               guifg=#4682b4   guibg=#a63131   gui=none
