...
if &t_Co > 255
	...
	hi CursorLineNr            ctermbg=4   ctermfg=249
	...
	" statusline
	hi StatusLine              ctermfg=7   ctermbg=52   cterm=none
	hi StatusLineNC            ctermfg=52  ctermbg=7
	hi StatusModFlag           ctermfg=9   ctermbg=52   cterm=none
	hi StatusRO                ctermfg=13  ctermbg=52   cterm=none
	hi StatusHLP               ctermfg=10  ctermbg=52   cterm=none
	hi StatusPRV               ctermfg=11  ctermbg=52   cterm=none
	hi StatusFTP               ctermfg=12  ctermbg=52   cterm=none
	...
	hi StatusModFlag           ctermfg=red     ctermbg=darkgrey    
	hi StatusRO                ctermfg=magenta ctermbg=darkgrey    
	hi StatusHLP               ctermfg=green   ctermbg=darkgrey    
	hi StatusPRV               ctermfg=yellow  ctermbg=darkgrey    
	hi StatusFTP               ctermfg=blue    ctermbg=darkgrey    
...
hi Comment                 guifg=#8C8B89 gui=italic
