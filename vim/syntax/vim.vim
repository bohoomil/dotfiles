...
syn keyword vimGroup contained	Comment Constant String Character Number Boolean Float Identifier Function Statement Conditional Repeat Label Operator Keyword Exception PreProc Include Define Macro Type PreCondit StorageClass Structure Typedef Special SpecialChar Tag Delimiter SpecialComment Debug Underlined Ignore Error Todo 
...
" Contitional {{{2
" ===========
syn cluster vimLoopList     contains=vimConditional
syn region vimIf     transparent matchgroup=vimConditional     start="\<if\>" matchgroup=vimConditional end="\<else\>" end="\<endif\>" contains=vimLoopList
syn keyword vim contained if else endif
...
hi def link vimLoopList             vimConditional
