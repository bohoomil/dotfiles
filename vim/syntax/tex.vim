...
"
" 1195-1199 lines altered by bohoomil
"
" Notes: {{{1
"
...
if did_tex_syntax_inits == 1
 let did_tex_syntax_inits= 2
  ...
  hi texboldstyle	ctermfg=14 ctermbg=none gui=bold   cterm=none
  hi texitalstyle	ctermfg=11 ctermbg=none gui=italic cterm=none
  hi texbolditalstyle	ctermfg=12  ctermbg=none gui=bold,italic cterm=none
  hi texitalboldstyle	ctermfg=12  ctermbg=none gui=bold,italic cterm=none
  hi texzone            ctermfg=9 ctermbg=none
