...
" My changes, second version -- bohoomil
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" INFO:
"
...
"set list listchars=tab:·· "causes problems with word wrapping
...
hi default t2tBar         term=bold        ctermfg=4         guifg=#406080
hi default t2tBold        term=bold        ctermfg=12        guifg=#5B88B3
hi default t2tItalic      term=standout    ctermfg=11        guifg=#CCB462
...
hi default t2tBoldItalic  term=bold,standout ctermfg=12 cterm=standout gui=bold,italic
"hi default t2tBar         term=bold        ctermfg=4         gui=bold
"hi default t2tBold        term=bold        ctermfg=12        gui=bold
"hi default t2tItalic      term=standout    cterm=standout    gui=italic
"hi default t2tUnderline   term=underline   cterm=underline   gui=underline
"hi default t2tQuote       term=reverse     cterm=reverse     gui=reverse
"hi default t2tTableAlign  term=reverse     cterm=reverse     gui=reverse
"hi default t2tBoldItalic  term=bold,standout ctermfg=12 cterm=standout gui=bold,italic
...
hi default      t2tIncluded      ctermfg=12
...
hi default link t2tDefListId     t2t_Component
hi default link t2tDefList       NONE
